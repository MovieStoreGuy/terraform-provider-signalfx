...
require (
	...
	github.com/splunk-terraform/terraform-provider-signalfx v0.0.0-00010101000000-000000000000
...
replace github.com/splunk-terraform/terraform-provider-signalfx => ../..
